  ...
  <?php $this->load->view($content); ?>
		...
		<!---footer--->
						...
						<div class="container">
							<div class="footer-grids">
								...
								<div class="col-md-3 footer-grid foot">
									<h4>Kontak</h4>
									<ul>
										<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i><a href="<?php echo base_url()."assets/"; ?>mainpage/#">JL. Jakarta 1990 , Kota Bandung</a></li>
					...
					<div class="copy-section">
						<div class="container">
							<div class="copy-left">
								<p>&copy; 2018 POPO . All rights reserved <a href="<?php echo base_url()."assets/"; ?>mainpage/http://w3layouts.com"></a></p>
							</div>
